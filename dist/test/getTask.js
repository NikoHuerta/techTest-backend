...
let idMongoTask = '';
(0, mocha_1.describe)('Obteniendo una tarea especifica: GET /api/task/:id', () => {
    before((done) => {
        const taskToBeCreated = new models_1.Task({
    ...
    (0, mocha_1.it)('Debe retornar un codigo de estado 200, y retornar la tarea consultada.', (done) => {
        chai_1.default.request(url)
            ...
            (0, chai_1.expect)(res.body.task).to.have.property('descripcion').to.be.eql('Test Description GET /api/task/:id');
